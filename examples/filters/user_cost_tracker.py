...
class Pipeline:
    ...
    def __init__(self):
        ...
        self.valves = self.Valves(
            **{
                ...
                "priority": 3,
                "cost_file": os.path.join(output_dir, "user_costs.json"),
            }
        )
    ...
    async def outlet(self, body: dict, user: Optional[dict] = None) -> dict:
        ...
        if model_data:
            ...
            # Round the total cost to 4 decimal places for monetary values
            total_cost = total_cost.quantize(Decimal("0.00001"), rounding=ROUND_HALF_UP)
